...
urlpatterns = [
    ...
    path('search', views.search_bar_query, name='search'),
    path('facility/', views.facility_list_view, name='facility-list'),
    path('facility/<int:primary_key>', views.facility_detail_view, name='facility-detail'),
    path('infotype/', views.infotype_list_view, name='infotype-list'),
    path('infotype/<int:primary_key>', views.infotype_detail_view, name='infotype-detail'),
    path('entry/', views.entry_list_view, name='entry-list'),
    path('entry/<int:primary_key>', views.entry_detail_view, name='entry-detail'),
    path('team/', views.team_list_view, name='team-list'),
    path('team/<int:primary_key>', views.team_detail_view, name='team-detail'),
